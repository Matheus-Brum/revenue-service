...
class RevenueServiceConfiguration:

    class __RevenueServiceConfiguration:
    ...
    def __init__(self):
        if not RevenueServiceConfiguration.instance:
            RevenueServiceConfiguration.instance = RevenueServiceConfiguration.__RevenueServiceConfiguration()
